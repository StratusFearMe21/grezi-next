...
enum {
  ...
  sym__text_ident = 26,
  sym_index_parser = 27,
  sym__vb_identifier = 28,
  sym_slide_from = 29,
  sym_slide_obj = 30,
  sym_slide_objects = 31,
  sym_slide_function = 32,
  sym_slide_functions = 33,
  sym_slide = 34,
  sym_viewbox_obj = 35,
  sym_viewbox_inner = 36,
  sym_viewbox = 37,
  sym_obj_inner = 38,
  sym_obj = 39,
  sym_action_obj = 40,
  ...
  aux_sym_slide_objects_repeat1 = 45,
  aux_sym_slide_function_repeat1 = 46,
  aux_sym_slide_functions_repeat1 = 47,
  aux_sym_viewbox_inner_repeat1 = 48,
  aux_sym_obj_inner_repeat1 = 49,
  aux_sym_action_obj_repeat1 = 50,
...
enum {
  ...
  field_direction = 3,
  field_function = 4,
  field_obj_w_viewbox = 5,
  field_objects = 6,
  field_operation = 7,
  field_parameters = 8,
  field_ty = 9,
  field_value = 10,
  field_viewbox_index = 11,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 73:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(73);
      if (sym_number_literal_character_set_1(lookahead)) ADVANCE(89);
      END_STATE();
    case 74:
      ACCEPT_TOKEN(sym_number_literal);
      ...
      if (('D' <= lookahead && lookahead <= 'F') ||
          ('d' <= lookahead && lookahead <= 'f')) ADVANCE(84);
      if (lookahead == 'L' ||
          lookahead == 'U' ||
          lookahead == 'W' ||
          lookahead == 'l' ||
    ...
    case 75:
      ...
      if (('B' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(84);
      if (lookahead == 'L' ||
          lookahead == 'U' ||
          lookahead == 'W' ||
          lookahead == 'l' ||
    ...
    case 80:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ...
          ('a' <= lookahead && lookahead <= 'c')) ADVANCE(81);
      END_STATE();
    case 81:
      ACCEPT_TOKEN(sym_number_literal);
      if (lookahead == '\'') ADVANCE(29);
    ...
    case 85:
      ...
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(78);
      if (sym_number_literal_character_set_2(lookahead)) ADVANCE(89);
      END_STATE();
    case 86:
      ACCEPT_TOKEN(sym_number_literal);
      if (lookahead == '+' ||
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(131)] = 1509,
  [SMALL_STATE(132)] = 1516,
  [SMALL_STATE(133)] = 1523,
  [SMALL_STATE(134)] = 1530,
  [SMALL_STATE(135)] = 1537,
  [SMALL_STATE(136)] = 1544,
  [SMALL_STATE(137)] = 1551,
  [SMALL_STATE(138)] = 1558,
  [SMALL_STATE(139)] = 1565,
  [SMALL_STATE(140)] = 1572,
  [SMALL_STATE(141)] = 1579,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(137),
  ...
  [26] = {.entry = {.count = 1, .reusable = false}}, SHIFT(51),
  [28] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [30] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [32] = {.entry = {.count = 1, .reusable = false}}, SHIFT(99),
  [34] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [36] = {.entry = {.count = 1, .reusable = true}}, SHIFT(139),
  [38] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [40] = {.entry = {.count = 1, .reusable = false}}, SHIFT(72),
  [42] = {.entry = {.count = 1, .reusable = true}}, SHIFT(72),
  [44] = {.entry = {.count = 1, .reusable = true}}, SHIFT(116),
  ...
  [56] = {.entry = {.count = 1, .reusable = true}}, SHIFT(106),
  [58] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [60] = {.entry = {.count = 1, .reusable = true}}, SHIFT(107),
  ...
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_obj, 4, .production_id = 5),
  ...
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_viewbox_inner, 5, .production_id = 12),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(121),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [90] = {.entry = {.count = 1, .reusable = true}}, SHIFT(118),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide, 2),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_obj_inner, 3),
  [96] = {.entry = {.count = 1, .reusable = false}}, SHIFT(18),
  [98] = {.entry = {.count = 1, .reusable = false}}, SHIFT(16),
  [100] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_register, 3),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_obj_inner, 6, .production_id = 10),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action, 3),
  [108] = {.entry = {.count = 1, .reusable = true}}, SHIFT(136),
  [110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(135),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_functions, 4),
  ...
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_obj_inner, 7, .production_id = 13),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_functions, 5),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action, 5),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_viewbox, 5, .production_id = 4),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_functions, 2),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_viewbox_inner, 3, .production_id = 9),
  [134] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(36),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2),
  [139] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(36),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action, 2),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_obj, 4, .production_id = 2),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index_parser, 3),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_obj_inner, 6, .production_id = 13),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_viewbox_inner, 4, .production_id = 12),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_viewbox_inner, 4, .production_id = 9),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_obj_inner, 2),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action, 4),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_obj_inner, 5, .production_id = 10),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_functions, 3),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_viewbox_inner_repeat1, 2),
  [164] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_viewbox_inner_repeat1, 2), SHIFT_REPEAT(96),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(110),
  [169] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [171] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_obj_inner_repeat1, 2), SHIFT_REPEAT(138),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_obj_inner_repeat1, 2),
  [176] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__vb_identifier, 1),
  ...
  [186] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_slide_objects_repeat1, 2), SHIFT_REPEAT(82),
  [189] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [191] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_action_repeat1, 2),
  [195] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_action_repeat1, 2), SHIFT_REPEAT(95),
  ...
  [226] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_slide_function_repeat1, 2), SHIFT_REPEAT(14),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_slide_function_repeat1, 2),
  [231] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_from, 4),
  ...
  [247] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_action_obj_repeat1, 2), SHIFT_REPEAT(13),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_action_obj_repeat1, 2),
  ...
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_slide_functions_repeat1, 2),
  [262] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_slide_functions_repeat1, 2), SHIFT_REPEAT(94),
  ...
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_obj, 5, .production_id = 5),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_viewbox_obj, 3, .production_id = 11),
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_obj_inner_repeat1, 4),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_obj, 5, .production_id = 7),
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_function, 3, .production_id = 6),
  [291] = {.entry = {.count = 1, .reusable = true}}, SHIFT(132),
  [293] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [295] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_function, 4, .production_id = 6),
  [297] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_obj, 8, .production_id = 7),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_viewbox_obj, 2, .production_id = 8),
  ...
  [309] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_obj, 6, .production_id = 7),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_function, 6, .production_id = 6),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_obj, 6, .production_id = 5),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_function, 5, .production_id = 6),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_obj, 7, .production_id = 7),
  ...
  [329] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_objects, 4, .production_id = 1),
  [331] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_objects, 4, .production_id = 3),
  [333] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [335] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_objects, 3, .production_id = 1),
  [337] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [339] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [341] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_objects, 3),
  ...
  [353] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_objects, 2),
  [355] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [357] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slide_objects, 5, .production_id = 3),
